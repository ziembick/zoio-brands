...
export default function EmailHover({ children }) {
  return (
    ...
    >
      ...
      <h1
        className={`${styles.segundo} mt-2 absolute left-0 inline-block translate-y-[120%] rotate-12 p-1 transition duration-500 ease-out group-hover:translate-y-0 group-hover:rotate-0`}
      >
        {children}
      </h1>
    </div>
